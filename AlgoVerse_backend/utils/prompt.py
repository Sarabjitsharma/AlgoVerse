...
2. <explanation> — 2–3 sentences explaining what the page does and how to run it.
3. <dependencies> — List: "react", "react-dom", "lucide-react", "tailwindcss".

Now, generate the {algorithm} page with *the same quality, tone, and polish as the golden example*.
"""
)